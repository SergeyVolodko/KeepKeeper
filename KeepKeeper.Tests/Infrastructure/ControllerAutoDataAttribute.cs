...
namespace KeepKeeper.Tests.Infrastructure
{
    ...
    {
        public ControllerAutoDataAttribute()
            : base(new Fixture().Customize(new ControllerCustomization()))
        {
        }
    }

    internal class ControllerCustomization : CompositeCustomization
    {
        internal ControllerCustomization()
            : base(
                new HttpRequestMessageCustomization(),
                new ApiControllerCustomization(),
                new AutoNSubstituteCustomization()
                //new IgnoreVirtualMembersCustomization()
                )
        { }
    }
